...
# Load environment variables from Netlify UI, not from .env file
# Make sure OPENAI_API_KEY and OPENAI_ASSISTANT_ID are set in Netlify's environment variables
        ...
        while run.status in ['queued', 'in_progress', 'requires_action']:
            ...
            if run.status == 'requires_action':
                ...
                if tool_call.function.name == "get_available_cars":
                    ...
                    return jsonify({"response": car_data_result['summary'], "cars": car_data_result['cars'], "thread_id": thread_id})
